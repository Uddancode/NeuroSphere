...
# To Define emotion to product mapping
emotion_to_products = {
...
def detect_faces_and_emotions():
    ...
    # Saving only the emotion to CSV file
    csv_data.append({
    ...
    # Save CSV file with emotion data only
...
st.write("This web app detects emotions from a live webcam feed and suggests products based on the detected emotion. Making your shoppig experience smoother. Thanks for Using it !! Wishing you a Good Day 😊😊")
